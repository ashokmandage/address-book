...
public class UpdateEntry extends JFrame {
	...
	public UpdateEntry(String fname, String lname, String address, String city, String state, String zip, String phNo) {
		super("Add Entry");
		...
		jButton1.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				AddressBookMain.editEntry(new AddressBook(jTextField1.getText(), jTextField2.getText(),
